...
const CetakBuktiDUPage = () => {
 ...
 const handlePrint = () => {
   ...
   const printWindow = window.open('', '_blank', 'height=800,width=1100'); // Adjusted width slightly for F4 landscape
   ...
   const printSpecificStyles = `
     @media print {
        /* F4 size: ~215.9mm x 330.2mm. Use landscape. */
       @page {
           size: 215.9mm 330.2mm landscape; /* Attempt F4 landscape */
           /* Alternative: standard 'legal landscape' if F4 doesn't work reliably */
       ...
       body {
          ...
          font-size: 9pt; /* Base print font size */
          line-height: 1.15; /* Slightly adjusted line height */
       ...
       .print-container {
          ...
          gap: 5mm; /* Gap between the two receipts */
          padding: 0; /* Remove padding from container itself */
          border: none;
          box-shadow: none;
          page-break-inside: avoid; /* Try to prevent breaking container across pages */
       }
       .receipt-container {
          flex: 1;
          max-width: calc(50% - 2.5mm); /* Each takes half the width minus half the gap */
          border: 1px solid black;
          padding: 4mm; /* Padding inside each receipt */
          box-sizing: border-box;
          height: auto; /* Let height adjust */
          overflow: hidden; /* Hide overflow */
          break-inside: avoid; /* Try to prevent breaking inside a receipt */
       }

       /* --- FONT & LAYOUT OVERRIDES FOR PRINT --- */
       ...
       .receipt-container .p-2 { padding: 2mm !important; } /* Applied to receipt-container */
     ...
     setTimeout(() => {
       try {
         ...
         toast({
          ...
          printWindow.close(); // Close window on error too
       } finally {
