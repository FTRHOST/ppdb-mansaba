...
const Receipt: React.FC<{ data: BuktiDaftarUlangData; isArsip?: boolean; namaPetugas?: string | null }> = ({ data, isArsip = false, namaPetugas }) => {
    ...
    return (
      ...
      <div className={cn("receipt-container bg-white p-2 max-w-full print:max-w-none print:p-[4mm] mx-auto border border-black text-xs font-sans break-inside-avoid print:text-[9pt] print:leading-normal flex flex-col", isArsip ? "border-t-4 border-t-red-600" : "")}>
        ...
        <div className="text-center mb-1 border-b-2 border-black pb-1 print:mb-1 print:pb-1">
           <div className="flex justify-center items-center mb-1 print:mb-1">
                {/* Placeholder for logo - Adjusted sizes */}
                <div className="w-10 h-10 bg-gray-200 flex items-center justify-center mr-2 rounded-full overflow-hidden flex-shrink-0 print:w-10 print:h-10 print:mr-2" data-ai-hint="school logo">
                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-green-700 print:w-6 print:h-6">
                ...
                <div className="flex-grow print:text-[9pt] print:leading-tight">
                    <h1 className="text-xs font-bold print:text-[10pt]">PANITIA</h1>
                    <h2 className="text-sm font-bold text-green-700 print:text-[11pt]">PENDAFTARAN PESERTA DIDIK BARU</h2>
                    <h2 className="text-base font-bold text-green-700 print:text-[12pt]">MA NU 01 BANYUPUTIH</h2>
                    <h3 className="text-xs font-bold print:text-[10pt]">TAHUN PELAJARAN 2025/2026</h3>
                </div>
           </div>
        </div>
         {isArsip && <p className="text-center text-sm font-semibold text-red-600 mb-1 print:text-[10pt] print:mb-1">Untuk Panitia</p>}
        <h3 className="font-bold text-center mb-2 underline text-base print:text-[11pt] print:mb-2">BUKTI DAFTAR ULANG</h3>

         {/* Added receipt-content wrapper */}
         <div className="receipt-content flex-grow">
            ...
            <hr className="border-dashed border-gray-400 my-1 print:my-1" />
            ...
            <div className="mb-2 print:mb-2">
                ...
                <p className="mb-1 text-xs font-medium print:text-[9pt] print:mb-1">Berkas yang diserahkan:</p>
                {/* Ensure checklist items don't wrap unnecessarily */}
                <div className="ml-2 grid grid-cols-1 gap-y-0.5 print:ml-2 print:gap-y-0.5">
                ...
                <div className="mt-1 flex items-center print:mt-1">
                     <ChecklistItem checked={data.bayarDaftarUlang} label="Daftar Ulang" />
                      {data.bayarDaftarUlang && (
                         <span className="ml-1 bg-black text-white font-semibold px-1 py-0.5 rounded text-[9pt] print:text-[8pt] print:ml-1 print:px-1 print:py-0.5">
        ...
        {/* Footer Box - Moved to receipt-footer */}
        <div className="receipt-footer">
            <div className={cn("border border-black p-1.5 text-center my-1 text-[8pt] leading-tight print:text-[8pt] print:my-1 print:p-1.5 small-print", isArsip ? "min-h-[35px]" : "")}>
                {!isArsip && (
                    <>
