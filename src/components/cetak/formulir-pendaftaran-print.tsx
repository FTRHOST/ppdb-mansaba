...
export const FormulirPendaftaranPrint: React.FC<{ data: FormulirData }> = ({ data }) => {
   ...
   useEffect(() => {
       ...
       const storedUri = localStorage.getItem('customLetterheadUri'); // Key matches settings page
       console.log("FormulirPrint: Loaded letterhead URI from localStorage:", storedUri); // Debug log
       if (storedUri) {
